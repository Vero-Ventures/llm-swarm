...
from game_creator.crew import GameDeveloperCrew
from langchain_community.output_parsers.rail_parser import GuardrailsOutputParser  # Updated import based on deprecation warning

def run():
    input = input("Prompt: ")
    crew_instance = GameDeveloperCrew()
    crew_instance.crew().kickoff(inputs=input)
